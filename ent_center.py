...
avatar = media.Movie("Avatar", "A marine on an alien planet",
                     ...
                     "Zoe Saldana, Sam Worthington, Sigourney Weaver, Stephen Lang")

black_panther = media.Movie("The Black Panther",
                            "A prince takes his fathers place to lead the wakandan nation",
                            "https://upload.wikimedia.org/wikipedia/en/0/0c/Black_Panther_film_poster.jpg",
                            "https://www.youtube.com/watch?v=xjDjIWPwcPU",
                            "Chadwick Boseman, Michael B Jordan, Lupita Nyongo, Angela Basset")

jumanji = media.Movie("Jumanji",
                      "Four friends find a video game that changes their lives",
